...
class PremiOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('Premi Pending', $this->calculate('Belum Dibayar'))->description('Dari tanggal ' . $start->format('d M Y') . ' sampai ' . $end->format('d M Y'))->color('danger'),
        ];
    }
