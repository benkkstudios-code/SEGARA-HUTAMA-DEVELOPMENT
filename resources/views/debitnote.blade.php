        ...
        <main>
            <div class="row .invoice-header">
                <div class="col-sm-9 text-start">
                    <h2 class="invoice-label">DEBIT NOTE</h2>
                    ...
                    <div class="row row-info">
                        ...
                        <div class="col-sm-8 text-start">
                            <p class="invoice-info">:&nbsp<strong>{{ $data['invoice']->transportasi }}</strong></p>
                            <p class="invoice-info">:&nbsp{{ $data['invoice']->lokasi_muat }}</p>
                            <p class="invoice-info">:&nbsp{{ $data['invoice']->pib }}</p>
                            <p class="invoice-info">:&nbsp{{ $data['invoice']->pengirim }}</p>
                        </div>
                    </div>
                </div>
                <div class=" col-sm-3 text-start">
                    <p class="mb-1 nominal-title"><strong>NOMINAL</strong></p>
                    <p class="nominal-text"> <strong>{{ $data['jumlah'] }}</strong></p>
                    <p class="mb-0 date-title"><strong>TANGGAL</strong></p>
                    <p class="date-text"> {{ $data['tanggal'] }}</p>
                    <p class="mb-0 nomor-title"><strong>NO. DEBIT NOTE</strong></p>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 text-end "
                    style="background-color:#4c70a0cf; color:white; padding-top: 10px;font-size:12px;">
                ...
                <div class="col-sm-9 text-start">
                    <div class="row ">
                        ...
                        <div class="col-sm-8 text-end">
                            <p class="mb-0">{{ $data['terbilang_jumlah'] }} Rupiah</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 text-end">
